...
(def ^:private collophon-chapters
  (md-as-chapters
   "# Collophon

This eBook was generated by a program written in Babashka, a Clojure implementation.
I'll probably post the program on GitHub sometime."))

(defn- make-chapters [frontmatter dreams]
...
(defn mk-epub [cover-image-path frontmatter dreams]
  (let [dates (m/dream-dates dreams)
        year-months (d/year-months dates)
        chapters (make-chapters frontmatter dreams)]
